...
require_relative '../../../lib/algorithm/tsp/double_tree'

reader = EdgeListReader.new :file => '../../files/K_10.txt'
...
db = DoubleTree.new :graph => g
result = db.get_edges :start_node => g.vertices[0]
